...
The basic idea of the package is to be able to launch EC2 instances. A really simple example is to launch an instance that comes preloaded with an RStudio Server Amazon Machine Image (AMI):
